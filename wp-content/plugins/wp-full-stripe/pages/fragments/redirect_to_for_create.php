...
<tr valign="top">
	...
	<td>
		...
		<div id="redirect_to_url_section" style="display: none;">
			<input type="text" class="regular-text" name="form_redirect_url" id="form_redirect_url" disabled placeholder="Enter URL" maxlength="<?php echo $form::REDIRECT_URL_LENGTH; ?>">
		</div>
	</td>
</tr>
