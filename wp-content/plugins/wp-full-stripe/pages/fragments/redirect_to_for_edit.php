	...
	<tr valign="top">
		...
		<td>
			...
			<div id="redirect_to_url_section" <?php echo( $editForm->redirectToPageOrPost == 1 ? 'style="display: none;"' : '' ) ?>>
				<input type="text" class="regular-text" name="form_redirect_url" id="form_redirect_url" <?php echo ( $editForm->redirectOnSuccess == '0' ) ? 'disabled' : '' ?> placeholder="Enter URL" value="<?php echo $editForm->redirectUrl; ?>" maxlength="<?php echo $form::REDIRECT_URL_LENGTH; ?>">
			</div>
		</td>
	</tr>
