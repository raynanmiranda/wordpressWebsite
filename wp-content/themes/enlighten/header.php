	...
	<header id="masthead" class="site-header" role="banner">
        ...
        <div class="ak-container">
            <?php
                ...
                $enlighten_header_social_link_enable = get_theme_mod('enlighten_enable_heade_social_icon');
            ...
            <?php if($enlighten_header_social_link_enable){ ?>
                <div class="header_social_link">
                    <?php do_action('header_social_link_action'); ?>
                </div>
            <?php } ?>
            </div>
            <?php } ?>
            ...
            <div class="logo_info_wrap">
              ...
              do_action('enlighten_action_custom_logo');
                ...
                $enlighten_enable_info = get_theme_mod('enlighten_enable_header_info');
                          ...
                          if($enlighten_number){ ?>
                            <div class="phone_header wow fadeIn">
                                ...
                                <div class="title_phone">
                                    <span class="pnone_title"><?php _e('Call Support','enlighten'); ?></span>
                          ...
                          if($enlighten_email){ ?>
                            <div class="email_header wow fadeIn">
                                ...
                                <div class="title_email_wrap">
                                    <span class="title_email"><?php _e('Email Support','enlighten'); ?></span>
                          ...
                          if($enlighten_location){ ?>
                            <div class="location_header wow fadeIn">
                                ...
                                <div class="title_location_wrap">
                                    <span class="title_location"><?php _e('Location','enlighten'); ?></span>
