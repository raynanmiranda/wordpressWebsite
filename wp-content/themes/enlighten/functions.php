...
function enlighten_setup() {
  ...
  * Images size
  */
 add_image_size('slider_image',1878,874,true);
 add_image_size('header_banner_image',1500,280,true);
 add_image_size('portfolio_image','358','276',true);
 add_image_size('service_image','49','46',true);
 add_image_size('testimonial_image','103','103',true);
 add_image_size('client_section','100','100',true);
 add_image_size('recent_news','380','400',true);
 add_image_size('recent_news_disable_twitter','294','400',true);
 add_image_size('footer_recent_news','331','197',true);
 add_image_size('mytheme-logo', 160, 70);
 add_image_size('single_page','800','385');
/**
 * Custom logo
 **/
...
function enlighten_scripts() {
    ...
    wp_enqueue_script('enlighten-custom-js',get_template_directory_uri().'/js/custom.js',array('jquery','jquery-mb-YTPlayer','superfish','theia-sticky-sidebar','wow', 'hoverIntent','waypoints','bxslider','carousel','counterup'));
